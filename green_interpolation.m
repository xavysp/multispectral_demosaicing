...
function [green,mosaic,maski] = green_interpolation(mosaic, mask, pattern, sigma)

% interpolation missing pixel by xavysp

[new_mosaic,maski] = directional_interpolation(mosaic, mask);
...
% clip to 0-255 maximun and minimun image values
